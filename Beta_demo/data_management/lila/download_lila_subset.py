...
n_download_threads = 0

max_images_per_dataset = None # None

max_total_images = 1100
...
#MINE: SHORTEN TO MAX TOTAL IMAGES
if len(all_urls) > max_total_images:
    all_urls = random.sample(all_urls,max_total_images)
