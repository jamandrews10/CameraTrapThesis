...
from PySide6.QtWidgets import QScrollArea, QWidget, QStackedLayout
from PySide6.QtWidgets import QPushButton, QStackedWidget, QVBoxLayout, QHBoxLayout, QInputDialog, QApplication
